            ...
            <div class="dark-section">
                <div class="blue-screen">
                    <div class="user-info-card">
                        <div class="user-info">
                            <Avatar :image="user.avatar" shape="circle" class="user-profile" />
                    ...
                    <div>
                        <div v-for="(company, index) in companies" :key="index" class="company-item">
                            <div class="company-info">
                                <Avatar :image="company.logo" shape="circle" class="list-user-profile" />
            ...
            <div class="action-buttons">
                <div v-for="(action, index) in actions" :key="index" class="action-item"
                    ...
                    <div class="action-icon">
                        <Icon :name="action.icon" size="28" class="text-[#333333]" />
                    </div>
